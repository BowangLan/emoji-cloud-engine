...
def main():
    ...
    canvas = EllipseCanvas(720, 720)
    for emoji_vendor in list_vendor:
        saved_emoji_cloud_name = 'examples/results/emoji_cloud_circle_' + emoji_vendor + '.png'
        console.print("Plotting \"" + saved_emoji_cloud_name + "\"...")
